      ...
      <div className="flex flex-wrap justify-center gap-2 max-w-sm">
        {defaultPrompts.map((prompt, idx) => (
          <button
            ...
            className="text-nowrap rounded-full border border-border text-sm px-4 py-2 bg-secondary/50 hover:bg-accent hover:border-primary/30 text-secondary-foreground cursor-pointer transition-all duration-200"
          >
            {prompt}
          </button>
        ))}
